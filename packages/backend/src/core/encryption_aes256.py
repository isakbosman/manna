...
class EncryptedStringAES256(TypeDecorator):
    """
...
def encrypt_aes256(plaintext: str, aad: Optional[bytes] = None) -> str:
    """
...
def decrypt_aes256(ciphertext: str, aad: Optional[bytes] = None) -> str:
    """
...
def is_aes256_initialized() -> bool:
...
def get_encryption_info() -> dict:
    ...
    return {
        "initialized": is_aes256_initialized(),
